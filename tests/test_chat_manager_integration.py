...
async def test_send_message():
    ...
    try:
        # 发送消息
        await manager.send_message('test_chat', 'What is 2+2?')
...
async def test_multiple_chats():
    ...
    try:
        ...
        await asyncio.gather(
            manager.send_message('chat1', 'Hello from chat1'),
            manager.send_message('chat2', 'Hello from chat2'),
        )
...
async def test_interrupt():
    ...
    try:
        ...
        await manager.agents['chat1'].ensure_connected()

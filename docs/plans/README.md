...
Most documents in this directory were written before the repository was reorganized into:
...
These files are kept as implementation history. They are not the source of truth for today's repository layout.
